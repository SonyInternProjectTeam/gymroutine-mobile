...
async function getAllTemplates() {
  try {
    ...
    return templates.sort((a, b) => {
      // Firestore Timestamp 또는 Date 객체 처리
      const dateA = a.createdAt ? 
        (a.createdAt instanceof Date ? a.createdAt : new Date(a.createdAt.seconds * 1000)) 
        : new Date(0);
      const dateB = b.createdAt ? 
        (b.createdAt instanceof Date ? b.createdAt : new Date(b.createdAt.seconds * 1000)) 
        : new Date(0);
      return dateB - dateA;
    });
  } catch (error) {
